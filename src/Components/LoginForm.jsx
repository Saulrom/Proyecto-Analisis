  ...
  return (
    <> 
      <div className="w-11/12 max-w-[600px] bg-white px-10 py-20 rounded-3xl border-2 border-gray-100">
        <h1 className="text-5xl text-center font-semibold mt-4">Events Usap</h1>
        <div className="mt-8">
          ...
          <div className="mt-8 flex flex-col gap-y-4">
            <button onClick={handleSubmit} className="active:scale-[.98] active:duration-75 hover:scale-[1.01] ease-in-out transition-all py-3 rounded-xl bg-blue-800 text-white text-lg font-bold">
              Sign in
            </button>
            <div>
            {<Alert message={error}/> }
          ...
          <div className="mt-8 flex justify-center items-center">
            ...
            <Link to="/register">
            <button className="text-blue-800 text-base font-medium ml-2">
              Sign up
            </button>
            </Link>
          </div>
